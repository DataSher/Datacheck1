...
# Dictionary to store uploaded data by station and unit
uploaded_data = {}

# Selection of Station and Unit for upload
...
if fl is not None:
    ...
    # Store the uploaded data in the dictionary with (station, unit) as key
    uploaded_data[f"{station} {unit}"] = df
    st.success(f"Data for {station} {unit} uploaded successfully!")

# Dropdown to select station and unit for analysis
if uploaded_data:
    ...
    # Retrieve the corresponding data for selected station and unit
    selected_key = f"{selected_station} {selected_unit}"
    if selected_key in uploaded_data:
        ...
        # Continue with your bearing health index calculation and display logic here...
        
        st.write(f"Showing data for {selected_station} - {selected_unit} from {selected_start_date} to {selected_end_date}")
        
        # Your remaining code for bearing health index calculations...
